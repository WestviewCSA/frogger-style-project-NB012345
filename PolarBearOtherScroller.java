...
public class PolarBearOtherScroller{
	...
	public PolarBearOtherScroller() {
		forward 	= getImage("/imgs/"+"polarbearother.png"); //load the image for Tree
...
public boolean collided(penguin character) {
	...
	public PolarBearOtherScroller(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = PolarBearOtherScroller.class.getResource(path);
