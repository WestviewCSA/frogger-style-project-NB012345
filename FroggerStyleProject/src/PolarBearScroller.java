...
public class PolarBearScroller{
	...
	public PolarBearScroller() {
		forward 	= getImage("/imgs/"+"polarbear.png"); //load the image for Tree
...
public boolean collided(penguin character) {
	...
	public PolarBearScroller(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = PolarBearScroller.class.getResource(path);
